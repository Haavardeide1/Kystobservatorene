...
const BADGE_CATALOG: Badge[] = [
  ...
  { key: "national_observer",    title: "Nasjonal observatør", description: "Innsendinger fra 5+ fylker.",           progress: 0, threshold: 5,   tier: "gold",     category: "geografi",     status: "locked" },
  { key: "coast_master",         title: "Kystlinje mester",    description: "100 unike GPS‑punkter.",                progress: 0, threshold: 100, tier: "platinum", category: "geografi",     status: "locked" },
  { key: "week_streak",          title: "Uke‑streak",          description: "Send inn hver dag i 7 dager.",          progress: 0, threshold: 7,   tier: "bronze",   category: "streaks",      status: "locked" },
  { key: "month_streak",         title: "Måned‑streak",        description: "Send inn hver dag i 30 dager.",         progress: 0, threshold: 30,  tier: "gold",     category: "streaks",      status: "locked" },
  { key: "winter_observer",      title: "Vinter observatør",   description: "10 innsendinger i desember–februar.",   progress: 0, threshold: 10,  tier: "silver",   category: "streaks",      status: "locked" },
  { key: "summer_observer",      title: "Sommer observatør",   description: "10 innsendinger i juni–august.",        progress: 0, threshold: 10,  tier: "silver",   category: "streaks",      status: "locked" },
  ...
  { key: "calm_guardian",        title: "Rolig sjø‑vokter",   description: "10 innsendinger med rolig havflate.",   progress: 0, threshold: 10,  tier: "bronze",   category: "forhold",      status: "locked" },
  ...
  { key: "wave_expert",          title: "Bølge‑ekspert",       description: "20 innsendinger med bølgeretning.",     progress: 0, threshold: 20,  tier: "silver",   category: "forhold",      status: "locked" },
];
