...
export const LEVELS: LevelDef[] = [
  ...
  { level: 4,  title: "Havkjent",           minXp: 500,  color: "#2563eb", bg: "#dbeafe" },
  { level: 5,  title: "Kystmester",         minXp: 850,  color: "#7c3aed", bg: "#ede9fe" },
  { level: 6,  title: "Havkaptein",         minXp: 1300, color: "#9333ea", bg: "#f3e8ff" },
  { level: 7,  title: "Kystnavigator",      minXp: 1900, color: "#c026d3", bg: "#fae8ff" },
  { level: 8,  title: "Havborgerforsker",   minXp: 2700, color: "#e11d48", bg: "#ffe4e6" },
